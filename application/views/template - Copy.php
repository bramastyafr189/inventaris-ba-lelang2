            ...
            if ($this->session->userdata('nama_jabatan') == 'LPSE') {
                ...
                <li class="dropdown">
                    <a class="dropdown-toggle" data-toggle="dropdown" href="#">
                        <i class="fa fa-user fa-bell"></i> <span class="badge badge-danger badge-counter" id="lelangbaru"></span>
                    </a>
                    <!-- Dropdown - Alerts -->
                  <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="alertsDropdown">
                    <h6 class="dropdown-header">
                        Pemberitahuan Data Input Baru
                    </h6>
                    <a class="dropdown-item d-flex align-items-center" href="#">
                      ...
                      <div>
                        <span class="badge badge-danger badge-counter" id="lelangbaruisi"></span><span class="font-weight-bold"> Data Baru</span>
                      </div>
                    </a>
                  </div>
                    <!-- /.dropdown-user -->
